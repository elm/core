...
tests =
  let creationTests = suite "Creation"
      ...
      mappingAndFoldingTests = suite "Mapping and Folding"
        ...
        , test "keepIf" <| assertEqual (Array.fromList [2,4,6]) (Array.keepIf (\x -> x % 2 == 0) (Array.fromList [1..6]))
        , test "dropIf" <| assertEqual (Array.fromList [1,3,5]) (Array.dropIf (\x -> x % 2 == 0) (Array.fromList [1..6]))
        ]
