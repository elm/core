...
return {
  ...
  utcYear: function(d) { return d.getUTCFullYear(); },
  utcMonth: function(d) { return { ctor: monthTable[d.getUTCMonth()] }; },
  utcDay: function(d) { return d.getUTCDate(); },
  utcHour: function(d) { return d.getUTCHours(); },
