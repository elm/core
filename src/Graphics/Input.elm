...
-}
button : Stream.Message -> String -> Element
button =
...
-}
customButton : Stream.Message -> Element -> Element -> Element -> Element
customButton =
...
-}
checkbox : (Bool -> Stream.Message) -> Bool -> Element
checkbox =
...
-}
dropDown : (a -> Stream.Message) -> List (String, a) -> Element
dropDown =
...
-}
hoverable : (Bool -> Stream.Message) -> Element -> Element
hoverable =
...
-}
clickable : Stream.Message -> Element -> Element
clickable =
