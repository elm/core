...
-}
button : Mailbox.Message -> String -> Element
button =
...
-}
customButton : Mailbox.Message -> Element -> Element -> Element -> Element
customButton =
...
-}
checkbox : (Bool -> Mailbox.Message) -> Bool -> Element
checkbox =
...
-}
dropDown : (a -> Mailbox.Message) -> List (String, a) -> Element
dropDown =
...
-}
hoverable : (Bool -> Mailbox.Message) -> Element -> Element
hoverable =
...
-}
clickable : Mailbox.Message -> Element -> Element
clickable =
